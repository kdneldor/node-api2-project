...
When the client makes a `POST` request to `/api/posts`: WRITTEN
...
When the client makes a `POST` request to `/api/posts/:id/comments`: WRITTEN
...
When the client makes a `GET` request to `/api/posts`: WRITTEN
...
When the client makes a `GET` request to `/api/posts/:id`: WRITTEN
...
When the client makes a `GET` request to `/api/posts/:id/comments`: WRITTEN
...
When the client makes a `DELETE` request to `/api/posts/:id`: WRITTEN
...
When the client makes a `PUT` request to `/api/posts/:id`: WRITTEN
